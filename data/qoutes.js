...
`Дай человеку рыбу, и он будет сыт один раз. Дай человеку арбуз, и он сыт всю ночь.`,
...
`Сперва пойду куплю очки. А потом видно будет.`,
...
`Вольную борьбу знаешь? Я освободил.`,
...
`Однажды я пропустил два дня в щколе, теперь их называют суббота и воскресенье.`,
...
`Жизнь грустная, но до зарплаты смешная.`,
...
`Если сделать греческий салат 31 декабря то завтра он будет древнегреческим.`,
`Когда меня рожали тогда я и родился.`,
`Я такого не говорил.`,
]
